...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p b3a4c531-0afa-4317-9c2c-b2ad81c7a048
```

> `b3a4c531-0afa-4317-9c2c-b2ad81c7a048` is the password of the certificate, you can change it to any password you want.
